...
DeciderContext.prototype.activity = function() {
  ...
  var runActivity = function(name, version) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      // TODO persist args if necessary
      ...
      var attrLength = JSON.stringify(attrs).length;

      debug("attribute size: %s", humanize.fileSize(attrLength));

      if (attrLength >= 4096) {
        console.warn("Attributes are > 4kb:", attrs);
      }
